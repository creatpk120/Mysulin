...
<head>
	...
	<%
		...
		Bean_Usage_c cBean = myMgr.getUsageCheck(numb);	//삭제할 자료 가져오기
		
		if(request.getParameter("pass") != null) {
			String inPass = request.getParameter("pass");
			String dbPass = aBean.getUspw();
			if(inPass.equals(dbPass)) {
				myMgr.deleteUsageCheck(numb);
				String url = "usageCheck.jsp?numb=0";
...
<body bgcolor="#F0F8FF">
	<div align="center">
		...
		<form name="delFrm" method="post" action="usageCheckDel.jsp">
				...
				<tr>
					<td align="center">
						<table>
							...
							<tr>
								<td>담당자</td>
								<td><%=cBean.getU_usid()%></td>
							</tr>
							<tr>
								<td>처방일</td>
								<td><%=cBean.getU_date()%></td>
							</tr>
							<tr>
								<td>확인여부</td>
								<td><%=cBean.getU_check()%></td>
							</tr>
							<tr>
								<td>패스워드 확인</td>
