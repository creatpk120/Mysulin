...
<html>
<head>
	<title>stockListUpdate</title>
	<link href="../admin/style.css" rel="stylesheet" type="text/css">
	<script type="text/javascript">
		function updateCheck(numb) {
			document.regFrm.recnumb.value=numb;
			document.regFrm.action="stockListUpdateProc.jsp";
			document.regFrm.submit();
		}
	</script>
</head>

<body bgcolor="#F0F8FF" onLoad="regFrm.stock_exp.focus()">
	<div align="center">
		<br/><br/>
		<form name="regFrm" method="post" action="stockListUpdateProc.jsp">
					...
					<td bgcolor="#F0F8FF" align="center" valign="middle">
						<table border="1" cellpadding="2" align="center" width="600">
							...
							<tr>
								...
								<input type="button" value="추가하기" onClick="location.href='stockListWrite.jsp?numb=<%=numb%>&numb1=<%=numb1%>'"> &nbsp;&nbsp;
