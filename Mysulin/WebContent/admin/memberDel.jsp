...
<%
	...
	Bean_Admin aBean = myMgr.getMember2(numb);				//회원자료 가져오기
	
	if(request.getParameter("pass") != null) {
		String inPass = request.getParameter("pass");
		String dbPass = pBean.getUspw();
		if(inPass.equals(dbPass)) {
			myMgr.deleteMember(numb);
			String url = "memberList.jsp?numb=0";
...
<body bgcolor="F0F8FF">
	<div align="center">
		...
		<form name="delFrm" method="post" action="memberDel.jsp">
