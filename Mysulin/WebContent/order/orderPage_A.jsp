...
<%
	...
	vlist = myMgr.getOrderKeyWord("A제약");
					...
					<td align="center" valign="middle" bgcolor="#F0F8FF">
						<table border="1" cellpadding="2" align="center" width="600">
							<tr align="center" bgcolor="#6495ED">
								<td colspan="3"><font color="#FFFFFF"><b>인슐린 발주서_A제약</b></font></td>
							</tr>
							<tr>
								<td>인슐린 선택</td>
								<td>
								...
								<%
									...
									vlist1 = myMgr.getOrderKeyWord("A제약");
							...
							<tr>
								<td colspan="3" align="center">
									<input type="button" value="발주하기" onClick="order_Check()"> &nbsp;&nbsp;
